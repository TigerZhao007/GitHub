...
ua_list = ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',
           'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.12']
    ...
    def save_image(self, two_url):
        ...
        while True:
            try:
                ...
                print("-----name:",name)
                direc = 'C:/Users/14324/Desktop/mzitu/{}/'.format(name)
                print("direc:",direc)
