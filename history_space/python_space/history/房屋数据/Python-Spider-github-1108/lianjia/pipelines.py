...
class LianjiaPipeline(object):
    def process_item(self, item, spider):
        ...
        lis = (item['title'],item['jianjie'],item['guanzhurenshu'],item['shoucangrenshu'],item['link'],item['fangwuhuxing'],
               item['houseFloor'],item['jianzhumianji'],item['huxingjiegou'],item['taoneimianji'],item['buildingType'],
               item['houseOrientation'],item['jianzhujiegou'],item['Decoration'],item['tihubili'],item['ladder'],
               item['chanquannianxian'],item['gaipaidata'],item['jiaoyidata'],item['lastjiaoyidata'],item['fangwuyongtu'],
               item['fangwunianxian'],item['chanquansuoshu'],item['diyaxinxi'],item['fangbenbeijian'],item['totleprice'],
               item['meanprice'],item['taxprice'],item['houseData'],item['xiaoquname'],item['suozaiarea'],item['kanfangdata'],
               item['lianjiabianhao'],item['fangyuantese'],item['huxingfenjian']
            )
