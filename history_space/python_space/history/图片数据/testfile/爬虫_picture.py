# -*- coding: utf-8 -*-
"""
Created on Sat Mar 31 21:57:02 2018
...
#    temp_str = "http://image.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&fm=detail&lm=-1&st=-1&sf=2&fmq=1522509491798_D&fm=detail&pv=&ic=0&nc=1&z=&se=&showtab=0&fb=0&width=&height=&face=0&istype=2&ie=utf-8&word=NanneZ%E9%98%BF%E7%94%B7"
    ...
    for picture_url in list_picture:
        j += 1
        local_time_file_name = path + str(local_time) + str(j) + ".jpg"
