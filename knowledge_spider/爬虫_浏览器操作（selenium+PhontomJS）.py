...
时间：2019-10-13
作者: zuoshao（佐少）
代码说明：爬虫_浏览器操作（selenium+PhontomJS）
"""
# ######################################################################################################################
# 环境搭建
# ######################################################################################################################
'''
准备工具：python3.6, selenium, PhantomJS 安装selenium：
pip install selenium
安装PhantomJS: 按照系统环境下载phantomjs（https://phantomjs.org/）
...
try:
    ...
    driver.find_element_by_link_text('贴吧')           # 通过xpath方式定定位
